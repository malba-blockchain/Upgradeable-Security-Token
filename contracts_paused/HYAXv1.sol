...
contract HYAXv1 is ERC20Pausable, Ownable {
    ...
    function tokenEmission(uint256 _amount) public onlyOwner {
        require(_amount > 0, "Amount of HYAX tokens to emmit must be greater than zero");
        _mint(owner(), _amount);
    ...
    function investFromMatic() public payable returns (bool){
        ...
        uint256 totalHyaxTokenToReturn = totalInvestmentInUsd * hyaxPerUSD;
