...
contract HYAX is ERC20Pausable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("HYAXToken", "HYAX") Ownable() ReentrancyGuard() {
        ...
        // Whitelister address
        whiteListerAddress = 0x0000000000000000000000000000000000000000 ; //TO BE UPDATED
        
        // Treasury address
        treasuryAddress = 0x0000000000000000000000000000000000000000 ; //TO BE UPDATED

        // Address of MATIC token price feed (Oracle) on the blockchain https://polygonscan.com/address/0xAB594600376Ec9fD91F8e885dADF0CE036862dE0
        maticPriceFeedAddress = 0xAB594600376Ec9fD91F8e885dADF0CE036862dE0;

        // Oracle on MATIC network for MATIC / USD
        dataFeedMatic = AggregatorV3Interface(maticPriceFeedAddress);

        // Address of USDC token on the blockchain https://polygonscan.com/address/0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359
        usdcTokenAddress = 0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359;

        // Address of USDC token price feed (Oracle) on the blockchain https://polygonscan.com/address/0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7
        usdcPriceFeedAddress = 0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7;

        // Oracle on Mumbai network for USDC / USD
        ...
        // Address of USDT token on the blockchain https://polygonscan.com/address/0xc2132D05D31c914a87C6611C10748AEb04B58e8F
        usdtTokenAddress = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F;

        // Address of USDT token price feed (Oracle) on the blockchain https://mumbai.polygonscan.com/address/0x92C09849638959196E976289418e5973CC96d645
        usdtPriceFeedAddress = 0x92C09849638959196E976289418e5973CC96d645;

        // Oracle on Mumbai network for USDT / USD
        ...
        // Address of WBTC token on the blockchain https://polygonscan.com/address/0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6
        wbtcTokenAddress = 0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6;

        // Address of WBTC token price feed (Oracle) on the blockchain https://polygonscan.com/address/0xDE31F8bFBD8c84b5360CFACCa3539B938dd78ae6
        wbtcPriceFeedAddress = 0xDE31F8bFBD8c84b5360CFACCa3539B938dd78ae6;

        // Oracle on Mumbai network for WBTC/USD: 
        ...
        // Address of WETH token on the blockchain https://polygonscan.com/address/0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619
        wethTokenAddress = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619; 

        // Address of WETH token price feed (Oracle) on the blockchain https://polygonscan.com/address/0xF9680D99D6C9589e2a93a78A04A279e509205945
        wethPriceFeedAddress = 0xF9680D99D6C9589e2a93a78A04A279e509205945;

        // Oracle on Mumbai network for WETH/USD: 
