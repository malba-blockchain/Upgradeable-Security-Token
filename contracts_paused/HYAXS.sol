...
/**
 * @title HYAXS token over the Sepolia Network
 * @dev ERC20Pausable token with additional functionality.
 */
contract HYAXS is ERC20Pausable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("HYAXToken", "HYAX") Ownable() ReentrancyGuard() {
        ...
        //Setting the HYAX token price. In this case 600 000. Thats 0.006 USD with 8 decimals 10**8
        hyaxPrice = 600000;

        //Setting the minimum investment a buyer can get of HYAX token. In this case equivalent to $1 USD
        minimumInvestmentAllowedInUSD = 1 * 10 ** decimals();

        //Setting the maximum investment a buyer can get of HYAX token. In this case equivalent to $10,000 USD
